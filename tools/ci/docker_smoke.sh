...
# Substitute: crafter, coworld-crafter, 1.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-crafter:ci)
#   SMOKE_SLUG                 game slug                        (crafter)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/crafter)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/crafter-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-crafter:ci}}"
slug="${SMOKE_SLUG:-crafter}"
