#!/usr/bin/env python3
"""Summarise a crafter `.replay` as one strict-UTF-8 JSON object on stdout.

Python 3 standard library only: no Nim, no Docker, no emsdk. This is the JSON
view of the binary `COWLDCRF` replay the static wasm viewer parses, and it is
...
* the crafter CONTROL records — `register`, `directive`, `fallback`,
