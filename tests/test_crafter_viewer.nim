...
import crafter/[sim, labels, broadcast]
import helpers
...
suite "crafter viewer":
  ...
  test "36. the broadcast page is the starter's plus an appended block":
    ...
    let banner = "CRAFTER additions to the inherited coworld-ctf chrome"
    ...
    ## client/crafter_block.html — the file the AGENTS guide says to edit.
    ...
    check "window.CRAFTER_WIRE" in core
