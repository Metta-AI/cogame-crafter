...
# use-after-free fixed in crafter_replay.nim (emscripten_exit_with_live_runtime)
...
# crafter_error_len(). Aborting keeps linear memory intact, and the page reads
# crafter_stage_ptr/len afterwards to report what the runtime was doing.
switch(
  "passL",
  (&"""
  -o {distDir / "crafter_replay.js"}
  ...
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_crafter_load_replay,_crafter_frame,_crafter_input,_crafter_packet_ptr,_crafter_packet_len,_crafter_mismatch_tick,_crafter_error_ptr,_crafter_error_len,_crafter_stage_ptr,_crafter_stage_len
  """).replace("\n", " ")
)
